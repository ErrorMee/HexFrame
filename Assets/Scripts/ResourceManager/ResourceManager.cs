...
public class ResourceManager : Singleton<ResourceManager>
{
    ...
    private Dictionary<string, LoadingContext> loadingDic = new Dictionary<string, LoadingContext>();
    ...
    {
        foreach (string fileName in gameObjectDic.Keys)
        {
            ObjectPool<GameObject> pool = gameObjectDic[fileName];
            pool.Update();
